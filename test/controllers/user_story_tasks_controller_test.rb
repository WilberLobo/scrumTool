...
class UserStoryTasksControllerTest < ActionController::TestCase
  ...
  test "should create user_story_task" do
    assert_difference('UserStoryTask.count') do
      post :create, user_story_task: { description: @user_story_task.description, employee_id: @user_story_task.employee_id, task_id: @user_story_task.task_id, user_story_id: @user_story_task.user_story_id }
    end
  ...
  test "should update user_story_task" do
    patch :update, id: @user_story_task, user_story_task: { description: @user_story_task.description, employee_id: @user_story_task.employee_id, task_id: @user_story_task.task_id, user_story_id: @user_story_task.user_story_id }
    assert_redirected_to user_story_task_path(assigns(:user_story_task))
  end
